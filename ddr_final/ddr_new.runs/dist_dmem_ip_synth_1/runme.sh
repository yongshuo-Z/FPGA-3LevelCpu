...
HD_PWD='D:/Desktop/ddr_new/ddr_new.runs/dist_dmem_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_dmem_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_dmem_ip.tcl
