...
HD_PWD='D:/Desktop/ddr_new/ddr_new.runs/dist_ddrmem_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_ddrmem_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_ddrmem_ip.tcl
