...
HD_PWD='D:/Desktop/ddr_new/ddr_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sccomp_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sccomp_dataflow.tcl
