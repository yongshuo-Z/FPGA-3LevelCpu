...
#
# Generated by export_simulation on Sun Dec 15 19:40:51 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './dist_ddrmem_ip.sh' script.

./dist_ddrmem_ip.sh -reset_run
...
./dist_ddrmem_ip.sh -noclean_files

For more information on the script, please type './dist_ddrmem_ip.sh -help'.
